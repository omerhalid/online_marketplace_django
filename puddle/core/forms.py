...
from django.contrib.auth.forms import AuthenticationForm # This is a built-in form from Django.
from django.contrib.auth.models import User # This is a built-in model from Django.

class LoginFrom(AuthenticationForm): # This is a form that inherits from the AuthenticationForm.
    class Meta:
        model = User
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'w-full py-4 px-6 rounded-xl', 'placeholder': 'Password'}))
